    ...
    <div className={`flex transition-[width] duration-300 dark:bg-neutral-900`}>
      ...
      >
        <button
          ...
          className="h-11 w-11 md:h-9 md:w-9 flex items-center justify-center rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-700/75 cursor-pointer"
        ...
        <Link
          ...
          params={{ chatId: "new" }}
          title="New chat"
          className={`flex ml-1 items-center justify-center rounded-full transition-opacity duration-375 h-11 w-11 md:h-9 md:w-9 hover:bg-neutral-100 dark:hover:bg-neutral-700 ${
      ...
      <div
        className={`flex flex-col duration-300 max-h-[100dvh] md:max-h-screen bg-white dark:bg-neutral-900 md:static md:transition-[width] ${
          settings.sidebarOpen
            ? isMobile
              ? "fixed top-safe bottom-0 left-0 z-40 w-64 md:relative"
              : "fixed inset-y-0 left-0 z-40 w-64 md:relative"
            : "w-0 md:relative"
        }`}
      >
        {!isMobile && (
