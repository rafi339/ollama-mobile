...
export default function LaunchCommands() {
  ...
  if (isMobile) {
    return (
      <main className="flex h-[100dvh] w-full flex-col relative">
        <section className="flex-1 overflow-y-auto overscroll-contain relative min-h-0">
          <div className="max-w-[730px] mx-auto w-full px-4 pt-4 pb-20">
            <h1 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100">
              Launch
            </h1>
            <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
              Local agents are not available on mobile. Use cloud models in the chat.
            </p>
          </div>
        </section>
      </main>
