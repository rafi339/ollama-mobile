...
import { CogIcon, RocketLaunchIcon, PencilIcon, TrashIcon } from "@heroicons/react/24/outline";
                ...
                >
                  {editingChatId === chat.id ? (
                    ...
                    <>
                      ...
                      {isMobile && actionMenuChatId === chat.id && (
                        <div className="flex items-center gap-1 px-1">
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              startEditing(chat.id, chat.title || chat.userExcerpt || "");
                            }}
                            className="p-1 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-700 text-neutral-500 dark:text-neutral-400"
                          >
                          ...
                          <button
                            ...
                            className="p-1 rounded-md hover:bg-red-100 dark:hover:bg-red-900/30 text-red-500 dark:text-red-400"
                          >
