...
function ChatForm({
  ...
  const handleFilesUpload = async () => {
    try {
      ...
      // On mobile, fall back to the hidden file input
  ...
  return (
    <div className={`pb-3 px-3 pb-safe ${hasMessages ? "mt-auto" : "my-auto"}`}>
      {chatId === "new" && <Logo />}
      ...
      >
        ...
        {editingMessage && (
          <div className="w-full px-5 pb-2 flex items-center justify-between">
            <p className="text-xs text-neutral-500 dark:text-neutral-400">
              {isNativeMobile()
                ? "Tap below to cancel editing"
                : "Press ESC to cancel editing"}
            </p>
            {isNativeMobile() && onCancelEdit && (
              <button
                type="button"
        ...
        {(message.attachments.length > 0 || message.fileErrors.length > 0) && (
          <div className="flex gap-2 overflow-x-auto px-3 pt pb-3 w-full scrollbar-hide snap-x snap-mandatory">
            {message.attachments.map((attachment, index) => {
              ...
              >
                ...
                <button
                  ...
                  className="opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity text-neutral-400 hover:text-neutral-600 dark:text-neutral-500 dark:hover:text-neutral-300 -mr-1 cursor-pointer"
            ...
            {message.fileErrors.map((fileError, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity text-red-400 hover:text-red-600 dark:text-red-500 dark:hover:text-red-300 -mr-1 ml-auto"
        ...
        <div className="relative w-full px-5">
          <textarea
            ...
            spellCheck={false}
            inputMode="text"
            className={`allow-context-menu w-full overflow-y-auto text-base text-neutral-700 outline-none resize-none border-none bg-transparent dark:text-white placeholder:text-neutral-400 dark:placeholder:text-neutral-500 min-h-[24px] leading-6 transition-opacity duration-300 ${
        ...
        {/* Controls */}
        <div className="flex w-full items-center justify-end gap-2 px-3 pt-2 flex-wrap">
            ...
            <div className="flex-1 flex justify-end items-center gap-2">
              <div className={`flex gap-2`}>
                ...
                <button
                  ...
                  className="flex h-11 w-11 md:h-9 md:w-9 items-center justify-center rounded-full bg-white dark:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer border border-transparent"
                  title="Upload multiple files"
                >
                  <PlusIcon className="w-5 h-5 md:w-4.5 md:h-4.5 stroke-2 text-neutral-500 dark:text-neutral-400" />
                </button>
          ...
          <div className="flex items-center gap-2 relative z-20">
            ...
            <button
              ...
              className={`flex items-center justify-center h-11 w-11 md:h-9 md:w-9 rounded-full disabled:cursor-default cursor-pointer bg-black text-white dark:bg-white dark:text-black disabled:opacity-10 focus:outline-none focus:ring-2 focus:ring-blue-500`}
            >
