  ...
  return (
    ...
    >
      ...
      {message.attachments && message.attachments.length > 0 && (
        <div className="flex gap-2 mb-2 overflow-x-auto justify-end max-w-[85vw] md:max-w-md self-end snap-x snap-mandatory">
          {message.attachments
      ...
      <div className="message-container mb-8 max-w-[85vw] md:max-w-md self-end">
        <div
        ...
        >
          ...
          {/* Action buttons */}
          <div className={`absolute -bottom-5 right-1 flex items-center gap-2
                     ${
                       isFaded
                         ? "opacity-30"
